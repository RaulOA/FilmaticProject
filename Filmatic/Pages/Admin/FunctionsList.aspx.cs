...
{
    public partial class FunctionsList : System.Web.UI.Page
    {
        ...
        private void LoadDataFunctions()
        {
            using (var context = new CineMaxTicketsDB11Entities3())
            {
                gv_Functions.DataSource = context.sp_GetCinemaFunctionDataByID(null).ToList();
